...
{
    public partial class frmKennelRemove : Form
    {
        frmMainMenu parent;
        Kennels kennel = new Kennels();
        DataSet ds = new DataSet();

        public frmKennelRemove()
        {
            InitializeComponent();
        }
        ...
        private void frmKennelRemove_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            String strSQL = "DELETE FROM KENNELS, WHERE RES_ID = " + this.textBox1;
