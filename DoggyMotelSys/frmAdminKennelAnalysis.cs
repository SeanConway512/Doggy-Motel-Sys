...
{
    public partial class frmAdminKennelAnalysis : Form
    {
        frmMainMenu parent;
        Kennels kennel = new Kennels();
        DataSet ds = new DataSet();

        public frmAdminKennelAnalysis()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            String strSQL = "SELECT KENNEL_STATUS,FROM KENNELS,WHERE KENNEL_ID = " + this.textBox1;
        ...
        private void frmAdminKennelAnalysis_Load(object sender, EventArgs e)
        {
