...
{
    public partial class frmKennelUpdate : Form
    {
        frmMainMenu parent;
        Kennels kennel = new Kennels();
        DataSet ds = new DataSet();

        public frmKennelUpdate()
        {
            InitializeComponent();
        }
        ...
        private void frmKennelUpdate_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            String strSQL = "SELECT KENNEL_STATUS,FROM KENNELS,WHERE KENNEL_ID = " + textBox1;
