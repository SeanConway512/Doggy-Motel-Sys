...
{
    public partial class frmReservationsCancelReservation : Form
    {
        frmMainMenu parent;
        DataSet ds = new DataSet();

        public frmReservationsCancelReservation()
        {
            InitializeComponent();
        }
        ...
        private void frmReservationsCancelReservation_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            String strSQL = "DELETE FROM RESERVATIONS WHERE RES_ID = " + this.textBox1;
